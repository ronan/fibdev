...
(function ($, Drupal) {
  ...
  Drupal.behaviors.savethebwFlyouts = {
    attach: function attach() {
      $('body').once('savethebw-flyouts').each(function () {
        // Main menu hovers and keyboard accessibility
        var dropdowns = document.querySelectorAll('.menu--main .dropdown');
        lodash_fp_map__WEBPACK_IMPORTED_MODULE_3___default()(function (item) {
          ...
          var showMenu = function showMenu() {
            ...
            lodash_fp_map__WEBPACK_IMPORTED_MODULE_3___default()(function (dropdown) {
              if (dropdown !== item) {
          ...
          hoverintent__WEBPACK_IMPORTED_MODULE_1___default()(item, showMenu, hideMenu); // Expand dropdown on enter, space, or down arrow
          ...
          trigger.addEventListener('focusout', function (evt) {
            if (evt.relatedTarget) {
              if (!lodash_includes__WEBPACK_IMPORTED_MODULE_2___default()(evt.relatedTarget.classList, 'menu-level-1') && !lodash_includes__WEBPACK_IMPORTED_MODULE_2___default()(evt.relatedTarget.classList, 'field-group-link')) {
                hideMenu();
              }
            }
          }); // Handle arrow navigation on links within dropdowns.

          lodash_fp_map__WEBPACK_IMPORTED_MODULE_3___default()(function (link) {
            link.addEventListener('keydown', function (evt) {
              switch (evt.keyCode) {
                case 40:
                  $(evt.target).parent().next('.dropdown-item').find('a').focus();
                  break;

                case 38:
                  {
                    $(evt.target).parent().prev('.dropdown-item').find('a').focus();
                ...
                case 37:
                  {
                    var $prev = $(evt.target).closest('.dropdown').prev('.dropdown').find('.dropdown-toggle');
                ...
                case 39:
                  {
                    var $next = $(evt.target).closest('.dropdown').next('.dropdown').find('.dropdown-toggle');

                    if ($next.length) {
                      $next.focus();
                    } else {
                      $(evt.target).closest('.dropdown').next('.nav-item').find('a.menu-level-0').focus();
                    }
          ...
          }, links); // When gaining focus on a top level link collapse the menu. I.e.
          // when tabbing forward to the next top level item that is not a
          // dropdown.

          document.querySelector('a.menu-level-0').addEventListener('focus', hideMenu); // Arrow key navigation on top level menu items

          var topLevelLinks = document.querySelectorAll('.menu-level-0');
          lodash_fp_map__WEBPACK_IMPORTED_MODULE_3___default()(function (link) {
            link.addEventListener('keydown', function (evt) {
              switch (evt.keyCode) {
                case 37:
                  $(evt.target).closest('.nav-item').prev('.nav-item').find('.menu-level-0').focus();
                  break;

                case 39:
                  $(evt.target).closest('.nav-item').next('.nav-item').find('.menu-level-0').focus();
                  break;
...
/***/ 4:
/*!***************************************!*\
  !*** multi ./js/savethebw.flyouts.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./js/savethebw.flyouts.js */"./js/savethebw.flyouts.js");


/***/ })

/******/ });
//# sourceMappingURL=savethebw.flyouts.js.map