...
(function ($, Drupal) {
  ...
  Drupal.behaviors.savethebwNav = {
    attach: function attach() {
      $('body').once('savethebw-nav').each(function () {
        ...
        // under the admin bar.
        var mmPage = document.querySelector('.mm-page');

        if (mmPage && window.MutationObserver) {
          /* eslint-disable no-new */
          var callback = function callback(mutationsList) {
            lodash_fp_map__WEBPACK_IMPORTED_MODULE_0___default()(function (entry) {
              var paddingTop = entry.target.style['padding-top'];

              if (paddingTop) {
                var sticky = document.querySelector('header.sticky-top');
...
/***/ 6:
/*!***********************************!*\
  !*** multi ./js/savethebw.nav.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./js/savethebw.nav.js */"./js/savethebw.nav.js");


/***/ })

/******/ });
//# sourceMappingURL=savethebw.nav.js.map